...
// export interface IBaseBlogPostRowOwnProps {
//   value: string
...
//   componentDidMount() {
//     if (!this.props.entities.posts[this.props.value]) {
//       this.load()
//     }
//   }
...
//     this.props.actions.get(this.props.value)
...
//         <Button
//           onClick={this.handleOnToggleFullView}
//         >
//           Hide
//         </Button>
//       </div>
